			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="fname"><i class="fa fa-user" ></i> Név</label>
					...
					<div class="col-50">
						...
						<input type="text" id="expdate" name="expdate" class="form-control" pattern="^((0[1-9])|(1[0-2]))\/(\d{2})$" placeholder="12/22"szükséges>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Szállítási cím ugyan az mint a számlázási cím
					</label>';
					$i=1;
					$total=0;
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Folytatás a kifizetéshez" class="checkout-btn">
				</form>
				</div>
			</div>
			';
