...
<div class="col-sm-7 ">
<label style="font-size:18px;">Jelszó</label><br>
<input class="input-lg" style="font-size:18px; width:200px" name="password" type="text"  id="password" value="<?php echo $user_password; ?>">
    <br><br></div>
    <div class="col-sm-7">
        <button type="submit" class="btn btn-success " name="btn_save" id="btn_save" style="font-size:18px">Hozzáadás</button></div>
</form>
</div></div>
