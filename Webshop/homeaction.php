								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='Kívánságlistához'><i class='fa fa-heart-o'></i><span class='tooltipp'>Kívánságlistához</span></button>
											<button class='Összehasonlítás'><i class='fa fa-exchange'></i><span class='tooltipp'>Összehasonlítás</span></button>
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='Kívánságlistához' tabindex='0'><i class='fa fa-heart-o'></i><span class='tooltipp'>Kívánságlistához</span></button>
											<button class='Összehasonlítás'><i class='fa fa-exchange'></i><span class='tooltipp'>Összehasonlítás</span></button>
											<button class='quick-view' ><i class='fa fa-eye'></i><span class='tooltipp'>quick view</span></button>
										</div>
									</div>
