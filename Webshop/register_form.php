						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Regisztrálj itt</h2>
                                    </div>
									
                                    <div class="form-group ">
                                    
                                        <input class="input form-control input-borders" type="text" name="f_name" id="f_name" placeholder="Keresztnév">
                                    </div>
									
                                    <div class="form-group">
                                    
                                        <input class="input form-control input-borders" type="text" name="l_name" id="l_name" placeholder="Vezetéknév">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="password" name="password" id="password" placeholder="Jelszó">
                                    </div>
									
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="password" name="repassword" id="repassword" placeholder="Megerősített jelszó">
                                    </div>
